...
<div class="features">
  <div class="feature">
    ...
    <h3>ファイナンス（投資理論）</h3>
    <p>資産価格やリスクに関する実証研究を行っています。暗号資産市場の暴落（メルトダウン）リスクとその分散、国際株式市場間の連動性の長期的な変遷、高頻度取引業者（HFT）と他の投資家の相互作用、金融政策の公表に対する外国為替市場の反応などを分析しています。</p>
  </div>
  <div class="feature">
  ...
  <div class="feature">
    ...
    <h3>テキストデータ分析</h3>
    <p>ニュース記事や有価証券報告書などのテキストを自然言語処理で分析し、株価や企業業績、景気との関係を明らかにします。金融・景気の極性辞書の構築、ニュースによる株式リターンの予測、ニュースから景況感を測る指数を用いたインフレ率やボラティリティの予測、経営者による将来見通しの開示と将来業績の関係などに取り組んできました。</p>
  </div>
</div>
